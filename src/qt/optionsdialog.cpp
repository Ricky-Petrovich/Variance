        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start Variance on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start Variance after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the Variance client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show Variance addresses in the transaction list"));
