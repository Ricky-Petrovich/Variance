...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("VARY");
    case mBTC: return QString("mVARY");
    case uBTC: return QString::fromUtf8("μVARY");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("VARY");
    case mBTC: return QString("Milli-VARY (1 / 1,000)");
    case uBTC: return QString("Micro-VARY (1 / 1,000,000)");
    default: return QString("???");
    }
}
