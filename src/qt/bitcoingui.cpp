 ...
 * The Variance Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Variance Wallet | Cloud Staking Available on GorillaStake.com"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Variance address"));
    ...
    aboutAction->setToolTip(tr("Show information about Variance"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Variance"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/toolbar"), tr("Show/Hide &Variance"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Variance window"));
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/Variance_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Variance_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Variance client"));
    ...
    notificator = new Notificator(tr("Variance-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Variance network", "", count));
}
